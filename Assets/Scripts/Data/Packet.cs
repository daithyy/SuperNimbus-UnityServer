...
/// <summary>Receiving to server from client.</summary>
...
public class Packet : IDisposable
{
    ...
    /// Creates a new empty <see cref="Packet"/> (without an ID).
    /// </summary>
    public Packet()
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Packet"/> class.
    /// Creates a new <see cref="Packet"/> with a given ID. Used for sending.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Packet"/> class.
    /// Creates a <see cref="Packet"/> from which data can be read. Used for receiving.</summary>
    ...
    /// <returns>readableBuffer.</returns>
    public byte[] ToArray()
    {
        readableBuffer = buffer.ToArray();
    ...
    /// <returns>Length() - readPos.</returns>
